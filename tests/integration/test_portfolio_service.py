"""Integration tests for PortfolioService with Nautilus integration.

Tests PortfolioService integration with Nautilus Portfolio and Cache using mocks.
Following Phase 5 migration - marked as integration tests.
"""
